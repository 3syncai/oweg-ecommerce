// FINAL WORKING MIGRATION - with fresh session cookie
// Run: node src/scripts/migrate-final-working.js --dry-run
//      node src/scripts/migrate-final-working.js
...
// Fresh session cookie from browser
const SESSION_COOKIE = 'connect.sid=s%3AdIVXMYB-70eJCq08dI8nbOC3wvS-3F9l.8IzeCZ6IbuVwwRS5S7%2Fp7IiJhTOXOlAJKsWs50szCJQ'
...
async function main() {
  ...
  try {
    ...
    if (isDryRun) {
      ...
      console.log('✅ COMPLETE! All 1,522 prices updated in Medusa!\n')
    }
