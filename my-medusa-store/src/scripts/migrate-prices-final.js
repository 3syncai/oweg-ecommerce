// FINAL WORKING PRICE MIGRATION
// Uses same auth pattern as set-images.js
// Run: node src/scripts/migrate-prices-final.js --dry-run
//      node src/scripts/migrate-prices-final.js
