...
// CORS is handled by Medusa's built-in framework CORS middleware via
// AUTH_CORS / STORE_CORS in medusa-config.ts. Setting headers here
// would produce duplicate Access-Control-Allow-Origin values.
